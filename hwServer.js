...
if (data.toString().trim() === "help" ) {
    ...
    text : "nice to meat you, if you type more cowbell I'll play trivia with you" ,
...
// play again
if (data.toString().trim() === "play again" ) {
        count = 0;
        randomPresident;
         randomizer;
       socket.write(cowsay.say({
    text : "Let's play again! type more cowbell to start another game" ,
